...
/**
 * The polyline encoding is a lossy compressed representation of a list of
 ...
 * <li>It allows to encode a 3rd dimension with a given precision, which may be
 * a level, altitude, elevation or some other custom value
 * </ul>
 * <p>
 */
public class PolylineEncoderDecoder {
  ...
  /**
   * Header version
   * A change in the version may affect the logic to encode and decode the rest of
   * the header and data
   */
  public static final byte FORMAT_VERSION = 1;

  // Base64 URL-safe characters
  public static final char[] ENCODING_TABLE = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_"
      .toCharArray();
   ...
   *
   * @param coordinates       {@link List} of coordinate triples that to be
   *                          encoded.
   ...
   */
  public static String encode(List<LatLngZ> coordinates, int precision, ThirdDimension thirdDimension,
  ...
  /*
   * Stateful instance for encoding and decoding on a sequence of Coordinates part
   * of an request.
